...
let aboutFaves =
  ...
  "<p>I am trying, and failing to be briefd about what goes on here in this weird strange place and I'll leave it where it is for now but there's so much more it's honestly gross. We haven't even gotten to talking about the multiple alternate dimensions that it also somehow tangentially takes place in.</p>";
